...
| **Diebold-Mariano-Test** (RPS, *propres* Scoring, 1186 Spiele 2022–2025, Modell vs. Pinnacle-Closing) | Auf 1X2 schlägt die **Closing-Line das Modell signifikant**: RPS 0.1972 vs. 0.2008. Leak-frei und **dependence-aware** geprüft (Newey-West-HAC **p=0.035**, Moving-Block-Bootstrap **p=0.043**; naiv iid p=0.039) — die Signifikanz hält also auch bei Berücksichtigung der Team-/Spieltag-Abhängigkeit. Auf Kicktipp-Punkten verschwindet der Unterschied (n.s.). Richtung extern repliziert (Pitcan 2026). |
...
Eine GitHub Action generiert täglich um 10:00 MESZ automatisch Tipps für den nächsten Spieltag (wenn dieser innerhalb von 3 Tagen liegt) und legt sie unter `tips/YYYY_YYYY_spieltag_XX.md` ab (z.B. `2025_2026_spieltag_31.md`).
